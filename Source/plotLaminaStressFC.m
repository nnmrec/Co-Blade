function plotLaminaStressFC(SIM, BLADE, WEB, MATS, Panel, LaminaSS, OUT)
...
if OUT.PLOT_S11_FC
    % ---- tension failure criteria    
    figTitle = [SIM.case ' lamina 1st principal stress failure criteria (tension)'];
    ...
    for i = 1:NUM_SEC
        ...
        for j = 1:Panel(i).Top.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Top(j).s_11_fc_T{k}, 'Color', cmap(Panel(i).Top.matID{j}(k),:))
            end
        end
        ...
        for j = 1:Panel(i).Bot.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Bot(j).s_11_fc_T{k}, 'Color', cmap(Panel(i).Bot.matID{j}(k),:))
            end
        end
        ...
        for j = 1:nWebs(i)
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, s_w, LaminaSS(i).Web(j).s_11_fc_T{k}, 'Color', cmap(Panel(i).Web.matID{j}(k),:))
            end
        end
    ...
    for i = 1:3
        ...
        if i == 1
            zlabel(ha(i), '\sigma_{11} / \sigma_{11, fT}')
        end
        xlim(ha(i), [0 1])
        ylim(ha(i), [0 1])
        title(ha(i), ttl(i));
    ...
    figTitle = [SIM.case ' lamina 1st principal stress failure criteria (compression)'];
    fig = figure('name', figTitle, ...
                 'color', 'white', ...
                 'units','normalized',...
                 'outerposition',[0.1 0.1 0.8 0.8]);
    ...
    for i = 1:NUM_SEC
        ...
        for j = 1:Panel(i).Top.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Top(j).s_11_fc_C{k}, 'Color', cmap(Panel(i).Top.matID{j}(k),:))
            end
        end
        ...
        for j = 1:Panel(i).Bot.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Bot(j).s_11_fc_C{k}, 'Color', cmap(Panel(i).Bot.matID{j}(k),:))
            end
        end
        ...
        for j = 1:nWebs(i)
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, s_w, LaminaSS(i).Web(j).s_11_fc_C{k}, 'Color', cmap(Panel(i).Web.matID{j}(k),:))
            end
        end
    ...
    for i = 1:3
        ...
        if i == 1
            zlabel(ha(i), '\sigma_{11} / \sigma_{11, fC}')
        end
        xlim(ha(i), [0 1])
        ylim(ha(i), [0 1])
        title(ha(i), ttl(i));
...
if OUT.PLOT_S22_FC
    % ---- tension failure criteria    
    figTitle = [SIM.case ' lamina 2nd principal stress failure criteria (tension)'];
    fig = figure('name', figTitle, ...
                 'color', 'white', ...
                 'units','normalized',...
                 'outerposition',[0.1 0.1 0.8 0.8]);
    ...
    for i = 1:NUM_SEC
        ...
        for j = 1:Panel(i).Top.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Top(j).s_22_fc_T{k}, 'Color', cmap(Panel(i).Top.matID{j}(k),:))
            end
        end
        ...
        for j = 1:Panel(i).Bot.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Bot(j).s_22_fc_T{k}, 'Color', cmap(Panel(i).Bot.matID{j}(k),:))
            end
        end
        ...
        for j = 1:nWebs(i)
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, s_w, LaminaSS(i).Web(j).s_22_fc_T{k}, 'Color', cmap(Panel(i).Web.matID{j}(k),:))
            end
        end
    ...
    for i = 1:3
        ...
        if i == 1
            zlabel(ha(i), '\sigma_{22} / \sigma_{22, yT}')
        end
        xlim(ha(i), [0 1])
        ylim(ha(i), [0 1])
        title(ha(i), ttl(i));
    ...
    % ---- compression failure criteria 
    figTitle = [SIM.case ' lamina 2nd principal stress failure criteria (compression)'];
    fig = figure('name', figTitle, ...
                 'color', 'white', ...
                 'units','normalized',...
                 'outerposition',[0.1 0.1 0.8 0.8]);
    ...
    for i = 1:NUM_SEC
        ...
        for j = 1:Panel(i).Top.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Top(j).s_22_fc_C{k}, 'Color', cmap(Panel(i).Top.matID{j}(k),:))
            end
        end
        ...
        for j = 1:Panel(i).Bot.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Bot(j).s_22_fc_C{k}, 'Color', cmap(Panel(i).Bot.matID{j}(k),:))
            end
        end
        ...
        for j = 1:nWebs(i)
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, s_w, LaminaSS(i).Web(j).s_22_fc_C{k}, 'Color', cmap(Panel(i).Web.matID{j}(k),:))
            end
        end
    ...
    for i = 1:3
        ...
        if i == 1
            zlabel(ha(i), '\sigma_{22} / \sigma_{22, yC}')
        end
        xlim(ha(i), [0 1])
        ylim(ha(i), [0 1])
        title(ha(i), ttl(i));
...
if OUT.PLOT_S12_FC
    figTitle = [SIM.case ' lamina principal shear stress failure criteria'];
    fig = figure('name', figTitle, ...
                 'color', 'white', ...
                 'units','normalized',...
                 'outerposition',[0.1 0.1 0.8 0.8]);
    ...
    for i = 1:NUM_SEC
        ...
        for j = 1:Panel(i).Top.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Top(j).s_12_fc_S{k}, 'Color', cmap(Panel(i).Top.matID{j}(k),:))
            end
        end
        ...
        for j = 1:Panel(i).Bot.nPanels  
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, x_c, LaminaSS(i).Bot(j).s_12_fc_S{k}, 'Color', cmap(Panel(i).Bot.matID{j}(k),:))
            end
        end
        ...
        for j = 1:nWebs(i)
            ...
            for k = 1:nLam
                hold on
                plot3(z_L, s_w, LaminaSS(i).Web(j).s_12_fc_S{k}, 'Color', cmap(Panel(i).Web.matID{j}(k),:))
            end
        end
...
end % function plotLaminaStressFC
